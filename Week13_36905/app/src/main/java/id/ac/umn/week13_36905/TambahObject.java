package id.ac.umn.week13_36905;
...
import id.ac.umn.week13_36905.databinding.ActivityTambahObjectBinding;
...
public class TambahObject extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SupportMapFragment mapFragment = (SupportMapFragment)
                getSupportFragmentManager().findFragmentById(R.id.tambahmap);
                ...
                switch(pilihan){
                    ...
                    case 1:
                        ...
                        if(mMap != null){
                            ...
                            if(rad.length() > 0 && Double.parseDouble(rad) > 0.0){
                                ...
                                objMS = new MarkerDanShape("Circle", etKeterangan.getText().toString(),
                                        radius, titiks);
                                btnSimpan.setEnabled(true);
                            }
                        }
                    ...
                    case 2:
                        ...
                        if(titiks.size()==1){
                            ...
                            mMap.addPolyline(pl);
                            objMS = new MarkerDanShape("PolyLine", etKeterangan.getText().toString(), 0, titiks);
                            btnSimpan.setEnabled(true);
                        }
                        break;
                    case 3:
