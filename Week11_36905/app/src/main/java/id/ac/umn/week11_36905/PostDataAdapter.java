package id.ac.umn.week11_36905;
...
public class PostDataAdapter extends RecyclerView.Adapter<PostDataAdapter.PostViewHolder>{
    ...
    @NonNull
    @Override
    public PostDataAdapter.PostViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) { View itemView = inflater.inflate(R.layout.post_item, parent, false);
